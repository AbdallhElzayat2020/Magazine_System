...
<body class="navbar-fixed sidebar-nav fixed-nav">
            ...
            <div class="tab-pane active" id="timeline" role="tabpanel">
                ...
                <div class="callout callout-warning m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assetsAdmin/img/avatars/7.jpg') }}" class="img-avatar"
                ...
                <div class="callout callout-info m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assetsAdmin/img/avatars/4.jpg') }}" class="img-avatar"
                            alt="admin@bootstrapmaster.com">
                    </div>
                    <div>Skype with
                        <strong>Megan</strong>
                ...
                <div class="callout callout-danger m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/2.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="i{{ asset('assetsAdmin/mg/avatars/3.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/4.jpg') }}" class="img-avatar"
                        ...
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/5.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                ...
                <div class="callout callout-primary m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        ...
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/3.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/4.jpg') }}" class="img-avatar"
                        ...
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assetsAdmin/img/avatars/8.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('assetsAdmin/js/libs/jquery.min.js') }}"></script>
    <script src="{{ asset('assetsAdmin/js/libs/tether.min.js') }}"></script>
    <script src="{{ asset('assetsAdmin/js/libs/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assetsAdmin/js/libs/pace.min.js') }}"></script>

    <!-- Plugins and scripts required by all views -->
    <script src="{{ asset('assetsAdmin/js/libs/Chart.min.js') }}"></script>
    ...
    <script src="{{ asset('assetsAdmin/js/views/main.js') }}"></script>
